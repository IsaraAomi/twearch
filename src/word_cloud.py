...
def create_word_cloud_from_csv(file_path):
    ...
    wc = WordCloud(
        ...
        stopwords={"みたい","そう","あと","こと","もの","これ","ため","それ","ところ","よう","co","https","http","RT","C1","そこ","ここ","感じ","さん","わけ","すぎ","どこ","あれ","とき","まま","しない","うち","なん","なんだろう","マジ","めちゃくちゃ","とりあえず","きた","だめ","しよう","以下","もん","わからん","自分","今回","今日","明日","先生","ダメ","amp","the","in","gt","on","t","の","ん","マジで","A","v","x","さ","ついで","K","O","0","B","C","人","的","化","W","次","先","R","E","s","版","Y","P","J","I","v","やつ","はず","かね","以上","ホント","アレ","問題","個人","普通","流石","コロナ"},
...
def main():
    ...
    - Returns:
    """
    create_word_cloud_from_csv("../data/list_20220924-042956.csv")
